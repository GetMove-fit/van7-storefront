  ...
  return (
    <section className="relative flex justify-between overflow-hidden pl-5 max-xl:flex-col sm:pl-10 lg:max-h-screen lg:pl-32 2xl:pl-48">
      ...
      <div className="z-10 flex flex-col gap-y-6 py-6 sm:gap-y-10 sm:py-10 lg:py-20">
        <div className="3xl:text-3xl 3xl:leading-normal flex flex-col gap-y-4 text-lg sm:gap-y-6 sm:text-xl lg:text-xl">
        ...
        <LocalizedClientLink
          href="hubbett-kaufen"
          className="3xl:text-3xl 3xl:py-8 h-fit w-fit rounded bg-gradient-to-b from-brand-light to-brand-dark px-6 py-4 font-bold uppercase leading-none text-white transition-shadow hover:shadow-lg hover:shadow-brand-highlight/30 sm:px-8 sm:py-5 sm:text-lg lg:text-xl"
        >
