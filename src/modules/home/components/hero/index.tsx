  ...
  return (
    <section className="relative flex overflow-hidden bg-gradient-to-b from-grey-5 to-white py-6 pl-5 max-xl:flex-col sm:py-10 sm:pl-10 lg:pl-20 xl:pl-36">
      <div className="flex flex-col gap-y-6 sm:gap-y-10">
        ...
        <button className="h-fit w-fit rounded bg-gradient-to-b from-brand-light to-brand-dark px-6 py-4 font-bold uppercase leading-none text-white transition-shadow hover:shadow-lg hover:shadow-brand-highlight/30 sm:py-5 sm:text-xl lg:text-2xl">
