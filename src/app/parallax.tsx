...
export function Parallax() {
  ...
  return (
    <div id="bg_hero" className="h-3/4 relative w-full overflow-hidden bg-[#fbfbfb] place-items-center">
      <div className="flex w-full place-content-center">
        <h1 className="font-title uppercase text-white/60 absolute bg-blend-hard-light text-center text-3xl sm:text-6xl sm:leading-none mt-5">
