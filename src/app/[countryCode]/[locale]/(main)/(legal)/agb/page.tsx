  ...
  return (
    <>
      ...
      <p>
        ...
        USt-IdNr.: ATU750929296
        Inhaber: Stefan Reßler

        (im Folgenden „Anbieter“ oder „wir“) und unseren Kunden (im Folgenden „Kunde“ oder „Sie“) ausschließlich unter Verwendung von Fernkommunikationsmitteln (also z.B. über das Internet oder per Telefon) in unserem Online-Shop oder über unsere Internetseiten geschlossen werden.
        ...
        (4)Der Vertrag kommt erst durch die Abgabe der Annahmeerklärung durch uns zustande, die mit einer gesonderten E-Mail versandt wird. Die Stellung einer Rechnung an den Kunden für die jeweils vom Kunden bestellte Ware ersetzt die Annahmeerklärung. Die Annahmeerklärung kann durch uns außerdem dadurch ersetzt werden, dass wir die Bestellung innerhalb von 5 Tagen ab Eingang der Bestellung ausführen. Liegen mehrere der vorgenannten Annahmevarianten vor, erfolgt der Vertragsschluss beim jeweils zuerst eingetretenen Ereignis. In jedem Fall erhält der Kunde entsprechend den gesetzlichen Vorschriften eine Vertragsbestätigung in Textform.
        ...
        (2)Sofern es sich beim Kunden um einen Kaufmann, eine juristische Person des öffentlichen Rechts oder um ein öffentlich-rechtliches Sondervermögen handelt oder wenn der Kunde keinen allgemeinen Gerichtsstand innerhalb der Bundesrepublik Österreich hat, ist Gerichtsstand für alle Streitigkeiten aus Vertragsverhältnissen zwischen dem Kunden und dem Anbieter der Sitz des Anbieters.
